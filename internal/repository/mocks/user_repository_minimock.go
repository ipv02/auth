...
//go:generate minimock -i github.com/ipv02/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Expect(ctx context.Context, user *model.UserCreate) *mUserRepositoryMockCreateUser {
...
func (mmCreateUser *mUserRepositoryMockCreateUser) ExpectUserParam2(user *model.UserCreate) *mUserRepositoryMockCreateUser {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserRepositoryMock.CreateUser mock is already set by Set")
	}
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Inspect(f func(ctx context.Context, user *model.UserCreate)) *mUserRepositoryMockCreateUser {
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Set(f func(ctx context.Context, user *model.UserCreate) (i1 int64, err error)) *UserRepositoryMock {
	if mmCreateUser.defaultExpectation != nil {
...
// Then helper
func (mmCreateUser *mUserRepositoryMockCreateUser) When(ctx context.Context, user *model.UserCreate) *UserRepositoryMockCreateUserExpectation {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserRepositoryMock.CreateUser mock is already set by Set")
	}
...
func (mmCreateUser *UserRepositoryMock) CreateUser(ctx context.Context, user *model.UserCreate) (i1 int64, err error) {
...
func (mmGetUser *mUserRepositoryMockGetUser) Return(up1 *model.UserGet, err error) *UserRepositoryMock {
	if mmGetUser.mock.funcGetUser != nil {
		mmGetUser.mock.t.Fatalf("UserRepositoryMock.GetUser mock is already set by Set")
	}
...
func (mmGetUser *mUserRepositoryMockGetUser) Set(f func(ctx context.Context, id int64) (up1 *model.UserGet, err error)) *UserRepositoryMock {
	if mmGetUser.defaultExpectation != nil {
...
func (e *UserRepositoryMockGetUserExpectation) Then(up1 *model.UserGet, err error) *UserRepositoryMock {
...
func (mmGetUser *UserRepositoryMock) GetUser(ctx context.Context, id int64) (up1 *model.UserGet, err error) {
